...
public class MasterCreationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finishButton.setOnClickListener(v -> sendMessage(masterRole , WaitForPeerConfigurationActivity.class));
    ...
    public void startAdvertising() {
        ...
        Nearby.getConnectionsClient(getApplicationContext())
                ...
                .addOnSuccessListener(aVoid -> Log.d("MANAGER", "Start_Advertising_Result: SUCCESS"))
    ...
    public ConnectionLifecycleCallback connectionLifecycleCallback = new ConnectionLifecycleCallback() {
        ...
        public void onConnectionInitiated(@NonNull String s, @NonNull ConnectionInfo connectionInfo) {
            ...
            peers.get(peersCounter).setText(String.format( "%s is ready" , connectionInfo.getEndpointName()));
